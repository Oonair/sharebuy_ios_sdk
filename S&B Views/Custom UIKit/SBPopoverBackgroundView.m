//
//  OOPopoverBackgroundView.m
//  ShareBuy
//
//  Created by Pierluigi Cifani on 6/14/12.
//  Copyright (c) 2012 Oonair. All rights reserved.
//


//Based on http://thinkvitamin.com/code/ios/customizing-the-design-of-uipopovercontroller/
...
@implementation SBPopoverBackgroundView

-(id)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        _borderImageView = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"bg-popover"] resizableImageWithCapInsets:UIEdgeInsetsMake(CAP_INSET,CAP_INSET,CAP_INSET,CAP_INSET)]];
        
        _arrowView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"bg-popover-arrow"]];
...
-  (void)layoutSubviews {
    ...
    switch (self.arrowDirection) {
        ...
        case UIPopoverArrowDirectionUp:
            ...
            _arrowView.frame = CGRectMake(_coordinate, +3, ARROW_BASE, ARROW_HEIGHT);
            break;
